...
test('Testing counta', () => {
  expect.assertions(3)
  const res = simplePivot(
    iris, { groupField: 'species', valueField: 'petal_width', pivotFunction: 'counta' })
  expect(res[0].species).toBe('setosa')
  expect(res[0].petal_width).toBe(50)
...
test('Testing average (avg)', () => {
  expect.assertions(3)
  const res = simplePivot(
    iris, { groupField: 'species', valueField: 'petal_width', pivotFunction: 'avg' })
  expect(res[0].species).toBe('setosa')
  expect(res[0].petal_width).toBe(0.2439999999999999)
...
test('Testing average (average)', () => {
  expect.assertions(3)
  const res = simplePivot(
    iris, { groupField: 'species', valueField: 'petal_width', pivotFunction: 'average' })
  expect(res[0].species).toBe('setosa')
  expect(res[0].petal_width).toBe(0.2439999999999999)
...
test('Testing median', () => {
  expect.assertions(3)
  const res = simplePivot(
    iris, { groupField: 'species', valueField: 'petal_width', pivotFunction: 'median' })
  expect(res[0].species).toBe('setosa')
...
test('Testing mode', () => {
  expect.assertions(3)
  const res = simplePivot(
    iris, { groupField: 'species', valueField: 'petal_width', pivotFunction: 'mode' })
  expect(res[0].species).toBe('setosa')
  expect(res[0].petal_width).toBe(0.2)
